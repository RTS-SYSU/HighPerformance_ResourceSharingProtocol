...
public class ExperimentMain {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // 实验变量为临界区长度
        final CountDownLatch cslendownLatch = new CountDownLatch(1);
        for (int i = 1; i < 7; i++) {
            final int count = i;
            new Thread(() -> {
...
//                    RL_ACMethod(tasks, resources, counter, resourceSharingFactor, finalI, RL_AC_STEP);
    ...
    private void RandomMethod(ArrayList<ArrayList<SporadicTask>> tasks, ArrayList<Resource> resources, Counter counter, int finalI, int RandomNum){
    ...
    private void RL_DQNMethod(ArrayList<ArrayList<SporadicTask>> tasks, ArrayList<Resource> resources, Counter counter, int condition, int finalI, int RL_DQN_STEP){
        ...
        try {
            ...
            ProcessBuilder builder = new ProcessBuilder("python", "run_dqn.py", arg1, arg2, arg3, arg4, arg5);
    ...
    private void RL_ACMethod(ArrayList<ArrayList<SporadicTask>> tasks, ArrayList<Resource> resources, Counter counter, int condition, int finalI, int RL_AC_STEP){
        ...
        try {
            ...
            ProcessBuilder builder = new ProcessBuilder("python", "run_ac.py", arg1, arg2, arg3, arg4, arg5);
            builder.redirectErrorStream(true); // 合并标准输出和错误输出
            Process process = builder.start();
            // 读取进程的输出
            BufferedReader reader = new BufferedReader(new InputStreamReader(process.getInputStream()));
...
//            long[][] Ris_2 = analysis_2.getResponseTimeByDMPO(tasks, resources, 1, true, true, true, true, false);
